...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,         }, "r", function () awful.spawn( "dmenu_run" ) end,
              {description = "Launch dmenu", group = "awesome"}),
    awful.key({ modkey,         }, "d", function () awful.spawn( "discord" ) end,
              {description = "Launch discord", group = "awesome"}),
    awful.key({ "Mod1",         }, "s", function () awful.spawn( "spotify" ) end,
              {description = "Launch spotify", group = "awesome"}),
